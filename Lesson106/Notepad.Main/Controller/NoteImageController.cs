...
//        // POST: /Images/Upload
//        [HttpPost("Upload")]
//        public IActionResult UploadImage([FromForm] ImageUploadRequest request, [FromForm] Note note) =>
//            noteImageService.UploadImageAndThumbnail(request.Image, note, out int noteImageId) ? Ok(noteImageId) : StatusCode(StatusCodes.Status400BadRequest);
